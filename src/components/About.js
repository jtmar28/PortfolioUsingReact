...
import tesla from "../TeslaSHP.jpg";
...
export default function About(){
  ...
  return (
    <main className="relative">
      <img src={tesla} alt="Tesla car" className="absolute w-full"/>
  ...
  <h1 className="cursive text-6xl text-green-300 mb-4">Hey there. I'm {" "}<span className="text-green-100">{author.name}</span></h1>
            <div className="prose lg:prose-xl text-white">
              <BlockContent blocks={author.bio} projectId="8dccyd7f" dataset="production"></BlockContent>
            </div>
          </div>
        </section>
      </div>
